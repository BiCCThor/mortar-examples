 ...
 */
%default INPUT_PATH 's3://mortar-example-data/tutorial/excite.log.bz2'
%default OUTPUT_PATH 's3://mortar-example-output-data/$MORTAR_EMAIL_S3_ESCAPED/excite/searches_by_age_bucket'
...
users = LOAD 's3://mortar-example-data/tutorial/users.txt'
       USING PigStorage('\t')
