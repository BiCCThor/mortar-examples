...
%default INPUT_PATH 's3://mortar-example-data/airline-data'
%default OUTPUT_PATH 's3://mortar-example-output-data/$MORTAR_EMAIL_S3_ESCAPED/airline-travel'
...
avg_delay_arrival_airport = FOREACH group_by_arrival_airport
